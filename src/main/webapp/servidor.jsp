<%-- 
    Document   : servidor
    Created on : 14 jul. 2021, 18:21:46
    Author     : PIERO
--%>
    ...
    <body>
        <%
            ...
            if (us == null) {
                ...
                Servidor servidor = (Servidor) request.getAttribute("servidor");
                            ...
                            success: function (response) {
                                ...
                                if (response == "TRUE") {
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Buen trabajo',
                                        text: "Servidor modificada correctamente",
                                    }).then((result) => {
                                        if (result.isConfirmed) {
                                            ListarServidor();
                                        }
                                    ...
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'ERROR',
                                        text: "Servidor no se puede modificar",
                                    }).then((result) => {
                                        if (result.isConfirmed) {
                                            ListarServidor();
                                        }
                        ...
                        <ul>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="servidor.jsp">Servidor</a>
        ...
        <div class="main">
            <div class="wrap">
                <div class="plans">
                    <h3>Servidores Registrados <button type="button" id="btnRegistro" class="btn btn-warning" data-toggle="modal" data-target="#modalRegistro">Registrar Nuevo</button></h3>
